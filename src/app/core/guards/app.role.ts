...
roles
    ...
    .createOwn([UserController.name, AuthController.name, CategoryController.name, BarcodeController.name, ItemController.name, StockController.name, WarehouseController.name, ShowroomController.name])
    ...
    .updateOwn([UserController.name, AuthController.name, CategoryController.name, BarcodeController.name, ItemController.name, StockController.name, WarehouseController.name, ShowroomController.name])
    .deleteOwn([UserController.name, AuthController.name, CategoryController.name, BarcodeController.name, ItemController.name, StockController.name, WarehouseController.name, ShowroomController.name])
